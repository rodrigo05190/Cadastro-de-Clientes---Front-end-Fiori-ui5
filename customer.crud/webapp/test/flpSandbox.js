		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#rodrigo606customercrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rodrigo606customercrud-display": {
								"semanticObject": "rodrigo606customercrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rodrigo606.customer.crud",
									"url": sap.ui.require.toUrl("rodrigo606/customer/crud")
								}
							}
						}
					}
